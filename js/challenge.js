...
heartButton.addEventListener("click", () => {
  if (clickedButton[counter]) {
    //2nd => if its not 1st click, increase counter by 1
    clickedButton[counter] = clickedButton[counter] + 1;
  } else {
    //1st => if it is the first click, create counter and assign 1
  ...
  if (element) {
    ...
    //1st => if it is the first click, create a li element and apply following
